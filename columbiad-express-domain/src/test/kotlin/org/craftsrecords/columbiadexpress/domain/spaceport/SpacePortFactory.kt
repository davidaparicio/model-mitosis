...
fun randomSpacePort(): SpacePort = SpacePort(name = randomUUID().toString(), location = values().random())
fun spacePort(astronomicalBody: AstronomicalBody): SpacePort {
    return SpacePort(id = fromString("fa9f2371-5b13-40a1-bd18-42db3371f073"), name = "name", location = astronomicalBody)
}
