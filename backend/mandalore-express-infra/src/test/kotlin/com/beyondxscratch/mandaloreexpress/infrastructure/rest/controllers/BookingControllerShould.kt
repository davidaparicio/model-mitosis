...
class BookingControllerShould(
    ...
    fun `create a booking from a selection`(@RoundTrip roundTripSearch: Search) {
        ...
        mvc.perform(
            ...
            .andExpect(jsonPath("$.spaceTrains[0].selectedFare.comfortClass").value(outboundFare.comfortClass.name))
            .andExpect(jsonPath("$.spaceTrains[0].selectedFare.price.amount").value(outboundFare.price.amount.value))
            .andExpect(jsonPath("$.spaceTrains[0].selectedFare.price.currency").value(outboundFare.price.currency.toString()))
            ...
            .andExpect(jsonPath("$.spaceTrains[1].selectedFare.comfortClass").value(inboundFare.comfortClass.name))
            .andExpect(jsonPath("$.spaceTrains[1].selectedFare.price.amount").value(inboundFare.price.amount.value))
            .andExpect(jsonPath("$.spaceTrains[1].selectedFare.price.currency").value(inboundFare.price.currency.toString()))
